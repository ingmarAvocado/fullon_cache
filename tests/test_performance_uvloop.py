...
from fullon_cache.event_loop import (
    EventLoopManager, EventLoopPolicy, configure_event_loop,
    get_policy_info, is_uvloop_active, benchmark_current_policy
)
from fullon_cache.connection import ConnectionPool, get_redis
...
class TestUvloopPerformance:
    ...
    async def test_basic_operations_benchmark(self):
        ...
        assert results['set_ops_per_sec'] > 100  # At least 100 ops/sec
        assert results['get_ops_per_sec'] > 100
